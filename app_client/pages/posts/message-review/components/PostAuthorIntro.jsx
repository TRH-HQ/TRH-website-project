  ...
  return (
    <section className="mt-6 border-t py-6 text-lg text-center xl:w-11/12">
      <div className="custom-text-color_secondary px-[12px] text-[14px] xsm:text-[16px]">
        ...
        laudantium repudiandae nam similique reiciendis exercitationem laborum unde esse incidunt
        commodi, eos impedit tempora deleniti.
      </div>
...
export default PostAuthorIntro;

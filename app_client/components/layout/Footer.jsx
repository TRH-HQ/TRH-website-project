    ...
    <section className="p-20 min-h-[200px] flex mt-16 custom-background_two">
      ...
      <div className="flex w-1/2 flex-col pl-12">
        ...
        <form className="form-area w-full flex mt-2">
          <input
            type="text"
            className="w-9/12 px-6 text-xl pt-[10px] pb-[6px] border-2 custom-border-color_primary_no-fill"
            style={{ borderRadius: 'none' }}
            placeholder="add email here"
          />
          <button className="w-3/12 custom-btn-colors_fill custom-text_white text-md pt-1 font-bold">
            Submit
          </button>
        </form>
        ...
        <div className="legal mt-4">
          Copyright <span className="text-2xl"> &copy;</span> 2022 The Reformer's House - All Rights
          Reserved
        </div>
      </div>
    </section>

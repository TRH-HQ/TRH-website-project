  ...
  return (
    ...
    >
      <aside className="left-side flex items-center mr-auto xl:mr-0">
        <button
          className="lg:mr-6 mr-[5px] menu-button custom-nav-btn-colors rounded-full w-[35px] h-[35px] p-[7px] lg:p-[7px] lg:w-[40px] lg:h-[40px] border"
          ...
          <a>
            <div className="brand-details flex items-center custom-text-color_primary">
              <svg
                ...
                // height="28"
                fill="currentColor"
                className="bi bi-house-door w-[22px] h-[22px]"
                viewBox="0 0 16 16"
              >
                <path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146zM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4H2.5z" />
              </svg>
              <div className="ml-1 text-[20px] lg:text-2xl font-bold montserrat custom-text-color_primary">
      ...
      <aside className="right-side flex items-center">
        ...
        <button
          className="ml-[12px] lg:ml-8 menu-button custom-nav-btn-colors rounded-full p-[6px] w-[30px] h-[30px] border border-gray-500"
        ...
        >
          <svg
            ...
            // height="16"
            fill="currentColor"
            className="bi bi-envelope-fill custom-text-color_primary-stay w-[14px] h-[14px] pl-[2px]"
            viewBox="0 0 16 16"
          >

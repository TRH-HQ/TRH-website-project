...
function MessageReviewCard() {
  return (
    <Link href="/message-review-card">
      <a className="w-full px-[12px] py-[20px] sm:w-3/4 sm:mx-auto lg:w-3/12 lg:mx-0 border-t lg:py-0 lg:border-t-0">
        <div className="message-review-card w-full mx-auto flex flex-row-reverse lg:flex-col">
          ...
          <div className="w-3/5 pr-[10px] lg:w-full">
            <div className="mt-3 post-title montserrat font-bold text-[13px] xsm:text-lg leading-[22px]">
